...
اقرأ التعليقات العامة على المقاطع واكتبها داخل Bunko باستخدام تسجيل الدخول إلى GitHub. تبقى المسودات والملاحظات الخاصة على جهازك حتى تختار نشرها. تتولى خدمة سحابية صغيرة عملية التفويض دون الحاجة إلى تشغيل حاسوب المالك، ويحفظ GitHub المحادثات العامة. تدعم الواجهة الإنجليزية والصينية المبسطة والتقليدية واليابانية. يتوفر الإصدار 1.0.5 (7) في الاختبار الداخلي على Google Play وفي TestFlight لنظامي iOS وMac؛ وتستمر مراجعات الإصدار 1.0.4 للنشر العام.
