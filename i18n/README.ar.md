...
يضم الفهرس الحي 150 طبعة معتمدة. تُنشر حزم الكتب الجديدة عبر GitHub دون إعادة بناء التطبيق؛ أما تغييرات كود القارئ فتحتاج إصدار ويب أو تطبيق جديد. يوضح سجل الإصدار أدناه توفر التطبيق ومراجعة التحديثات لكل منصة.
