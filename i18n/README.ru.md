...
[![Снимок читалки Bunko](../store/assets/play-phone-01.png)](../store/assets/play-phone-01.png)
...
В открытом каталоге 150 проверенных изданий. Новые книги публикуются через GitHub без пересборки приложения; изменения кода читалки требуют нового веб- или нативного выпуска. Первая платная версия проходит проверку в магазинах; текущий статус указан в связанном документе.
