...
[![Bunko 阅读器截图](../store/assets/play-phone-01.png)](../store/assets/play-phone-01.png)
...
在线书目已有 150 种通过审核的版本。新书可以通过 GitHub 发布，无须重新构建应用；阅读器代码的改动仍需发布新版网页或原生应用。首个付费版本正在商店审核，实时状态请查看链接中的发布记录。
